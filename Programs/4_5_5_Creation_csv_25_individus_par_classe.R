...
#ipmortation des individus depuis le presse-papier
...
#une table par classe d'âge avec 25 individus aléatoires (sauf la classe où il n'y a pas assez d'individus)
