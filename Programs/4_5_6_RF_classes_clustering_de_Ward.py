...
#importation des données de genre
...
#modification des tables (transposition et fusion)
...
#initialisation d'une liste vide pour stocker les score de chaque itération
score_RF=[]

#création de 3 bases pour les trois classes
#bébé : 0 à 1,5 ans
#adulte : 1,5 à 85 ans
...
for i in range(0,30):
    ...
    #trouver l'âge des individus mal classés
    #table avec l'âge des individus
    bd_age=bd_final[["age"]]
    bd_age=bd_age.add_suffix('_reel')
    #ajout de la classe à laquelle il appatient
    pred=pds.concat([y_test,bd_age],axis=1,join="inner")
    #ajout de la classe prédite
    pred.insert(2, "classe_predite", predictions1, True)
    #sélection des individus mal classés
